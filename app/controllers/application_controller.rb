class ApplicationController < ActionController::API
  ...
  def authenticate_token
    ...
    render json: { status: 401, message: 'authenticate_token Unauthorized' } unless decode_token(bearer_token)
  end
  ...
  def authorize_user
    ...
    render json: {status: 401, message: 'user Unauthorized'} unless get_current_user.id == params[:id].to_i
  end
